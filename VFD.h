...
const int Pin_VFD_RESET    = D1;      // VFD _RESET
const int Pin_VFD_VDON    = D2;      //     _VDON Vdisp 0=ON 1=OFF
const int Pin_VFD_CS    = D8;     //     _CS   chip select, SPI SS

const int Pin_VFD_SUCLK_A = D3;     //     SUCLK A, OC2A
const int Pin_VFD_SUCLK_B = D4;      //           B,    B, inverted
